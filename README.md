...
1. review and uncomment what you need in `environment.yml` and create an environment `rag_skeleton` with the help of [conda]:
   ```
...
> **_NOTE:_**  The conda environment will have rag_skeleton installed in editable mode.
